    ...
    <div className="flex flex-row justify-between">
      <div className="flex flex-row">
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="w-8 h-8 text-sky-500 rounded-full hover:bg-sky-900 hover:backdrop-opacity-50 brightness-75 p-1">
          <path
            strokeLinecap="round"
        ...
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="w-8 h-8 text-sky-700 rounded-full  brightness-75 p-1">
        ...
        <div className="flex flex-row gap-2  ">
          ...
          <div className="m-1 rounded-full border  border-slate-500 hover:bg-sky-900 hover:backdrop-opacity-50 ">
            <svg
              ...
              strokeWidth={1}
              stroke="currentColor"
              className="w-6 h-6 mx-0.5 text-sky-500">
