        ...
        <div className="border-t border-slate-500 p-3">
          <div className="flex flex-row justify-between">
            ...
            <div className="flex flex-row gap-2">
              <div className="flex flex-row gap-2  ">
                <div className="p-3 m-1 rounded-full border-2 border-slate-500 border-r-sky-500 -rotate-45"></div>
              ...
              <button className="bg-sky-500 px-6 py-0 hover:bg-sky-600 rounded-full shadow text-lg font-bold">Tweet</button>
            </div>
          </div>
        </div>
      </div>
